...
import { selectCompleted } from './todoSlice';
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div className="p-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-base font-semibold leading-6 text-gray-900">Completed</Dialog.Title>
                      ...
                      {completed.map((todo) => (
                        <li key={todo.id}>
                          <div className="group relative flex items-center py-6 px-5">
                            <a href={todo.content} className="-m-1 block flex-1 p-1">
                              ...
                              <div className="relative flex min-w-0 flex-1 items-center">
                                ...
                                <div className="ml-4 truncate">
                                  <p className="truncate text-sm font-medium text-gray-900">{todo.content}</p>
                                  <p className="truncate text-sm text-gray-500">{todo.datetime}</p>
                                </div>
                              </div>
                            </a>
