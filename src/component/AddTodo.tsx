...
import { CalendarIcon, PaperClipIcon, TagIcon, FlagIcon } from '@heroicons/react/20/solid'
...
export default function AddTodo({
  ...
  return (
    <form action="#" className="relative">
      <div className="overflow-hidden rounded-lg border border-gray-300 shadow-sm focus-within:border-gray-500 focus-within:ring-1 focus-within:ring-cyan-500">
        ...
        <textarea
          ...
          className="block w-full resize-none py-0 text-gray-900 border-transparent focus:border-transparent focus:ring-0 placeholder:text-gray-400 sm:text-sm sm:leading-6"
      ...
      <div className="absolute inset-x-px bottom-0">
        {/* Actions: These are just examples to demonstrate the concept, replace/wire these up however makes sense for your `pr`oject. */}
              ...
              <>
                ...
                <div className="relative">
                  <Listbox.Button className="relative inline-flex items-center whitespace-nowrap rounded-full bg-gray-50 py-2 px-2 text-sm font-medium text-gray-500 hover:bg-gray-100 sm:px-3">
                    ...
                    >
                      {labelled.value === null ? 'Priority' : labelled.name}
                    </span>
                  </Listbox.Button>
        ...
        <div className="flex items-center space-x-3 border-t border-gray-200 px-2 py-2 sm:px-3">
          {/* <div className="flex">
            <button
              type="button"
